...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'answer.model' => 'getAnswer_ModelService',
            'answer.repository' => 'getAnswer_RepositoryService',
            ...
            'envelope.model' => 'getEnvelope_ModelService',
            'envelope.repository' => 'getEnvelope_RepositoryService',
            ...
            'question.model' => 'getQuestion_ModelService',
            'question.repository' => 'getQuestion_RepositoryService',
    ...
    /**
     * Gets the 'answer.model' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Model\AnswersModel A AppBundle\Model\AnswersModel instance
     */
    protected function getAnswer_ModelService()
    {
        return $this->services['answer.model'] = new \AppBundle\Model\AnswersModel($this->get('doctrine.orm.default_entity_manager'), $this->get('answer.repository'), $this->get('question.repository'));
    }

    /**
     * Gets the 'answer.repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Repository\AnswersRepository A AppBundle\Repository\AnswersRepository instance
     */
    protected function getAnswer_RepositoryService()
    {
        return $this->services['answer.repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AppBundle\\Entity\\Answers');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'game', 'user' => 'root', 'password' => 'coderslab', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/AppBundle/Resources/config/doctrine') => 'AppBundle\\Entity', ($this->targetDirs[3].'/src/UserBundle/Resources/config/doctrine') => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_808734e4535de1077d985db0f9294f3d0e9372bbd555ad09a541c70890440a9a');
    ...
    /**
     * Gets the 'envelope.model' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Model\EnvelopeModel A AppBundle\Model\EnvelopeModel instance
     */
    protected function getEnvelope_ModelService()
    {
        return $this->services['envelope.model'] = new \AppBundle\Model\EnvelopeModel($this->get('doctrine.orm.default_entity_manager'), $this->get('envelope.repository'));
    }

    /**
     * Gets the 'envelope.repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Repository\EnvelopesRepository A AppBundle\Repository\EnvelopesRepository instance
     */
    protected function getEnvelope_RepositoryService()
    {
        return $this->services['envelope.repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AppBundle\\Entity\\Envelopes');
    }
    ...
    /**
     * Gets the 'question.model' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Model\QuestionsModel A AppBundle\Model\QuestionsModel instance
     */
    protected function getQuestion_ModelService()
    {
        return $this->services['question.model'] = new \AppBundle\Model\QuestionsModel($this->get('doctrine.orm.default_entity_manager'), $this->get('question.repository'));
    }

    /**
     * Gets the 'question.repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Repository\QuestionsRepository A AppBundle\Repository\QuestionsRepository instance
     */
    protected function getQuestion_RepositoryService()
    {
        return $this->services['question.repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AppBundle\\Entity\\Questions');
    }
